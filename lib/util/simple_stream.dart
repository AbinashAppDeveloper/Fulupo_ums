...
class AppRefreshableWidget extends StatelessWidget {
  ...
  const AppRefreshableWidget({super.key, required this.child});
...
enum SimpleStreamState { loading, hasData, hasError }
...
extension BuildContextExt on BuildContext {
  ...
  PaginationStream<K> selectPagination<T, K>(
    ...
    final paginationError = select(
      (T value) => selector(value).paginationError,
    );
    final secondaryLoading = select(
      (T value) => selector(value).secondaryLoading,
    );
