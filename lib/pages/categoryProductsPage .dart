...
class CategoryProductsPage extends StatefulWidget {
  ...
  final List<Gsmproductmodel> products;
...
class _CategoryProductsPageState extends State<CategoryProductsPage> {
 ...
 Future<void> _loadData() async {
  ...
  // IMPROVED: More robust image URL handling
  ...
  void _navigateToProductDetail(Gsmproductmodel product) {
    // Debug product images before navigating
  ...
  // IMPROVED: Enhanced image loading with better debugging
  ...
  Widget _buildFAB() {
    return Container(
      ...
      child: FloatingActionButton(
        onPressed: () async {
          final result = await AppRouteName.addProduct.push(context,args: {"category": widget.category.name}, );
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            Expanded(
              child: isGridView ? _buildListDesign() : _buildGridDesign(),
            )
          ],
        ),
      ),
  ...
  // Build app bar with curved bottom
  Widget _buildAppBar() {
    return ClipRRect(
